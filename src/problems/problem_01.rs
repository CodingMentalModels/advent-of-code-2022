...
pub fn solve_problem_01a(input: Vec<String>) -> usize {
    unimplemented!();
}

fn solve_problem_01b(input: Vec<String>) -> usize {
    unimplemented!();
}
...
mod test_problem_01 {
    ...
    fn test_problem_01a_passes() {
        ...
        let input = InputParser::new().parse_as_string("input_01.txt").unwrap();
